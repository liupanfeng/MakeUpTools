...
public class BeautyEffectUtil {
    ...
    public static void setMakeupBeautyArgs(NvsFx nvsVideoFx, List<BeautyFxArgs> shape, boolean microFlag) {
        if (nvsVideoFx == null) {
            return;
        }
...
//                            MakeupManager.getInstacne().putMapFx(beautyFxArgs.getDegreeName(), value);
     ...
     * @param videoClip
     */
    public static void resetMakeupFx(NvsVideoClip videoClip) {
        //滤镜
